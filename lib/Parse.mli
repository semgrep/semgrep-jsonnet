...
(**
    Functions for parsing jsonnet programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a jsonnet program from a string into a typed OCaml CST.
...
val string :
  ...
  CST.document Tree_sitter_run.Parsing_result.t

(** Parse a jsonnet program from a file into a typed OCaml CST.
